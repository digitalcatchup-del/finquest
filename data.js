...
const dailyTips = [
  ...
  {text:'"An investment in knowledge pays the best interest."',source:'Benjamin Franklin · Accounting'},
  ...
  {text:'"Accounting is the language of business."',source:'Warren Buffett · Accounting'},
