...
const articles = [
  {
    ...
    body: `Ask a new business owner how they're doing, and most will glance at their bank balance. It's an honest instinct — but it's also exactly the habit the accruals concept exists to correct.
